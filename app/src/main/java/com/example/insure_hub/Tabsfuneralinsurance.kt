...
class Tabsfuneralinsurance : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_tabsfuneralinsurance)
    ...
    private fun setupViewPager(viewpager: ViewPager) {
        ...
        // is a title of tab
        adapter.addFragment(funeralinsurancetab1(), "Principal Member Details")
        adapter.addFragment(funeralinsurancetab2(), "Beneficiary Details")
        adapter.addFragment(funeralinsurancetab3(), "Deceased Details")
        adapter.addFragment(funeralinsurancetab4(), "Document Upload")
