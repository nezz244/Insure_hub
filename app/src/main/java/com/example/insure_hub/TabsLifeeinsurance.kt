...
class TabsLifeeinsurance : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_tabs_lifeeinsurance)
    ...
    private fun setupViewPager(viewpager: ViewPager) {
        ...
        // is a title of tab
        adapter.addFragment(Lifeinsurancetab1(), "Principal Memmber Details")
        adapter.addFragment(Lifeinsurancetab2(), "Dependancy Details")
        adapter.addFragment(Lifeinsurancetab3(), "Beneficiary ")
        adapter.addFragment(Lifeinsurancetab4(), "Document Upload")
